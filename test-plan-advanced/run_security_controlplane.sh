#!/bin/bash
# Security Control Plane Overhead (E4) - Launcher
set -euo pipefail
...
echo "============================================================"
echo " Security Control Plane Overhead (E4) - Setup & Execution"
...
echo "[*] Running Security Control Plane evaluation..."
$PYTHON run_security_controlplane.py "$@"
